                            ...
                            <div class="ModuleContent">
                                @if($news):
                                    <section class="news-page clearfix">
                                        <h1 class="pagetitle">Chăn nuôi cùng chuyên gia</h1>
                                ...
                                @else:
                                    <h1>Hiện chưa có bài viết nào</h1>
                                @endif
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="sidebarcol col-xs-12 col-md-4 col-lg-12 Module Module-148">
                            <div class="ModuleContent">
                                <section class="news-video clearfix">
                                    ...
                                    <div class="video">
                                        <figure>
                                            <a data-fancybox="" class="videoimg d-block" href="{{ $feature_video->video_src }}" title="{{ $feature_video-> name}}">
                                                <img src="{{ asset('uploads/' . $feature_video->img) }}" alt="{{ $feature_video->name }}">
                                                <span class="play">
        </span>
                                            </a>
                                            <figcaption>
                                                <h3 class="videoname">
                                                    <a data-fancybox="" class="play" href="{{ $feature_video->video_src }}" title="{{ $feature_video->name }}">{{ $feature_video->name }}</a></h3>
                                            </figcaption>
                                        </figure>
                                    </div>
                                    @foreach($related_videos as $related_video)
                                        <div class="video">
                                            <figure>
                                                <figcaption>
                                                    <h3 class="videoname">
                                                        <a data-fancybox="" class="play" href="{{$related_video->video_src}}" title="{{ $related_video->name }}">{{ $related_video->name }}m</a></h3>
                                                </figcaption>
                                            </figure>
                                        </div>
                                    @endforeach
