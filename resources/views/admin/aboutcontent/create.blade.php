...
{!! Form::open(array('route' => config('quickadmin.route').'.aboutcontent.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('block_option', old('block_option'), array('class'=>'form-control')) !!}
